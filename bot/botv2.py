...
arquivoc = open(os.path.abspath(os.path.dirname(__file__))+"/pessoas.txt",'rb')
contatos = []
...
class Botezinhomelhor:
    def __init__(self):
        ...
        self.driver = webdriver.Chrome(executable_path= os.path.abspath(os.path.dirname(__file__))+"/chromedriver.exe", chrome_options=options)
